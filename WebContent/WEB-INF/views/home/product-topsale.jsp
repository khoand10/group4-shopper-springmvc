				...
				<div class="row">						
					<div class="span9">								
						...
						<c:forEach var="page1" items="${page1 }">
							<li class="span3">
								<div class="product-box">
									...
									<p class="price">$${page1.unitprice }</p>
								</div>
							</li>       
						</c:forEach>	
						</ul>								
						...
						<div class="pagination pagination-small pagination-centered">
							<ul>
								<li><a href="#">Prev</a></li>
								<li class="active"><a href="product_bestSeller.htm?page=1">1</a></li>
								<li><a href="product_bestSeller.htm?page=2">2</a></li>
								<li><a href="product_bestSeller.htm?page=3">3</a></li>
								<li><a href="#">Next</a></li>
							</ul>
						</div>
					</div>
